                                ...
                                <div class="mb-10">
                                    ...
                                    <div>
                                        <select class="form-select form-select-solid" data-kt-select2="true"
                                            ...
                                            data-dropdown-parent="#kt_menu_641ac43458397" data-allow-clear="true">
                                            <option></option>
                                ...
                                <div class="d-flex flex-stack flex-grow-1">
                                    ...
                                    <div class="fw-semibold">
                                        <div class="fs-6 text-gray-700">Two-factor authentication adds an extra layer of
                                            security to your account. To log in, in you'll need to provide a 4 digit
                                            amazing code.
                                ...
                                <div class="d-flex flex-stack">
                                    <div class="d-flex">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="fs-6 fw-semibold text-gray-400">Plan properly your workflow
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-end">
                            ...
                            <div class="card-body border-top px-9 py-9">
                                ...
                                <label class="form-check form-check-custom form-check-solid align-items-start">
                                    ...
                                    <span class="form-check-label d-flex flex-column align-items-start">
                                        ...
                                        <span class="text-muted fs-6">Receive a notification if a payment is disputed by
